...
let app = (
    <div className="container">
        <Header title="Women in STEM" subheading="A page to that holds tribute to the amazing females who contributed to the field of Science | Engineering | Technology | Math"/>
        <div className="cardsSlideshow">
